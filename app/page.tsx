    ...
    <main className="flex flex-col gap-51 md:gap-40 w-full items-center md:pt-40 md:px-140">
      ...
      <div className="flex flex-col gap-51 md:gap-40 px-16 md:p-0 w-full xl:w-1115">
        <div className="flex flex-col gap-8 w-full xl:w-1115 lg:w-800 items-center text-center">
          <span className="text-[32px] text-(--main-red) lg:w-342 w-full">Chez vous, partout et ailleurs</span>
          <span className="text-sm text-black font-normal w-full">Avec Kasa, vivez des séjours uniques dans des hébergements chaleureux, sélectionnés avec soin par nos hôtes.</span>
        </div>
      ...
      <Gallery />
      <div className="flex flex-col gap-40 w-full lg:w-1114 py-40 px-8 md:p-40 rounded-[10] bg-(--white)">
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-16 justify-center">
          <div className="flex flex-col text-(--white) bg-(--main-red) py-44 px-22 gap-17 w-full lg:w-270 rounded-[10] h-199">
