...
export default function MessagesPage() {
  return (
    <main className="flex flex-col md:gap-40 w-full items-center bg-(--white)">
      ...
      <div className="flex rounded-[10px] w-full">
        <div className="flex flex-col gap-7 border-r-1 border-solid border-(--light-grey) py-11 lg:px-8 w-full lg:w-376">
          ...
          <div className="flex flex-col w-full bg-(--light-orange)">
              ...
              <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-20">
                  <div className="flex gap-6">
                    <div className="min-w-28 h-28 bg-(--dark-grey) rounded-[6px]"></div>
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="flex flex-col gap-5 bg-(--white) p-6 rounded-se-[20px] rounded-es-[20px] rounded-ee-[20px] w-full">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="flex flex-col gap-10 bg-(--white) p-12 rounded-se-[20px] rounded-es-[20px] rounded-ee-[20px] w-full">
                        <span className="text-xs text-(--black) font-normal">Bonjour, votre appartement est-il disponible pour le week-end du 12 au 14 octobre ?</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex gap-6 justify-end">
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-10 bg-(--main-red) p-12 rounded-ss-[20px] rounded-es-[20px] rounded-ee-[20px] w-full">
            ...
            <div className="flex flex-col gap-10 py-21 px-30 border-t-1 border-solid border-t-(--light-grey) bg-(--white)">
              <div className="flex border border-solid border-(--light-grey) rounded-[10px] h-95 relative">
                <Input
                  name="message"
